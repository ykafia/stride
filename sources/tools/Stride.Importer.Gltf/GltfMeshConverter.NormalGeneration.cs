...
public partial class GltfMeshConverter
{
    struct Triangle
    {
        ...
        public System.Numerics.Vector3[] Positions = new System.Numerics.Vector3[3];
        public System.Numerics.Vector3[] Normals = new System.Numerics.Vector3[3];
        public System.Numerics.Vector2[] TexCoords = new System.Numerics.Vector2[3];
        public System.Numerics.Vector3[] Tangents = new System.Numerics.Vector3[3];
        public System.Numerics.Vector3[] BiTangents = new System.Numerics.Vector3[3];

        public Triangle() { }
        public System.Numerics.Vector3 FlatNormal => System.Numerics.Vector3.Cross(Positions[1] - Positions[0], Positions[2] - Positions[0]);
    }
    public void GenerateNormalsAndTangents(MeshPrimitive primitive, out System.Numerics.Vector3[] normals, out System.Numerics.Vector3[] tangents, bool flatNormals = false)
    {
        var posits = primitive.GetVertexColumns().Positions;
        var texcoords = primitive.GetVertexColumns().TexCoords0;
        var texcoords1 = primitive.GetVertexColumns().TexCoords1;
        List<Triangle> tris = primitive
            ...
            .Select(
                x => new Triangle
                {
                    ...
                    B = x.B,
                    C = x.C,
                    Positions = new System.Numerics.Vector3[] { posits[x.A], posits[x.B], posits[x.C] },
                    TexCoords = new System.Numerics.Vector2[] { texcoords[x.A], texcoords[x.B], texcoords[x.C] }
                }).ToList();
        normals = tris.Select(x => x.FlatNormal).ToArray();
        var mikk = new MikktspaceTangentGenerator(logger);
        mikk.Generate(primitive, normals, out tangents);        
    }
    //public void GenerateNormals(MeshPrimitive primitive, out Vector3[] normals, out Vector3[] tangents, out Vector3[] bitangents)
    //{
